...
/**
 * Created by softbaked on 9/12/16 AD.
 */
public class SafeSwitch extends SwitchCompat implements CompoundButton.OnCheckedChangeListener {
    ...
    public SafeSwitch(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public SafeSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
